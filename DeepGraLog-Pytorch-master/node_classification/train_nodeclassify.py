...
dataset = input("1: Local Request Graph, 2: Local Request Graph+Global Functionality Graph\n")
if dataset == '1':
    dimensionality = 4 # node feature dimension
    path_file=" " #  Local Request Graph Dataset address
    ...
    path_file=' '#Local Request Graph+Global Functionality Graph Dataset address
    p_input = input('1. training3 test7,  2. training5 test5\n') # Training set and test set partition proportion
    if p_input == '1':
        divide = 0.1
    elif p_input == '2':
...
graphSage = GraphSage(1, dimensionality, 128, device, gcn='store_true', agg_func='MAX')  # Create the GraphSage object

num_labels = 2

classification = Classification(128, num_labels)# Create the classificator
